<template>
  <div class="equipmentWrap">
    <div class="formContent">
      <a-form :form="form" layout="inline" class="forms">
        ...
        <a-form-item label="在线状态">
          <a-select defaultValue="在线" style="width: 120px" @change="handleChange">
            <a-select-option :value="item.value" v-for="item in statusList" :key="item.id">{{item.value}}</a-select-option>
          </a-select>
        </a-form-item>
        <a-form-item>
    ...
    <div class="tableContent">
      <a-table :rowSelection="rowSelection" :columns="columns" :dataSource="tableData" bordered>
